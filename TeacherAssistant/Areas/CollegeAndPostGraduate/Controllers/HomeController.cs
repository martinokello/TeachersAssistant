...
namespace TeacherAssistant.Areas.CollegeAndPostGraduate.Controllers
{

    [Authorize(Roles = "Administrator,CollegeAndPostGraduate")]
    public class HomeController : Controller
    {
        ...
        [HttpGet]
        [Authorize(Roles = "Administrator,Grammar11Plus,CollegeAndPostGraduate,StateJunior")]
        ...
        {
            var StudentResources = _teacherRepository.GetGroupedResourcesByRoleThenSubject("CollegeAndPostGraduate");
        ...
        public ActionResult DownloadPaidDocuments()
        {
            ...
            var documents = _teacherRepository.GetPaidDocuments("CollegeAndPostGraduate");
            var videos = _teacherRepository.GetPaidVideos("CollegeAndPostGraduate");
        ...
        public ActionResult ViewAssignmentGrades()
        {
            try
            {
                ...
                var assignments = _teacherRepository.GetCurrentAssignmentsSubmissions("CollegeAndPostGraduate", (int)studentId).Select(p =>
        ...
        public ActionResult SubmitAssignment(AssignmentSubmissionViewModel submissions)
        {
            ...
            var virtualPath = string.Format("~/StudentResources/CollegeAndPostGraduate/Assignments/Submissions/{0}/{1}", subject.SubjectName, CleanseAssignmentName(assignment.AssignmentName));
            ...
            var actualSubmission = new AssignmentSubmission
            {
                ...
                StudentRole = "CollegeAndPostGraduate",
        ...
        {
            ViewBag.AssignmentList = GetCurrentAssignmentList("CollegeAndPostGraduate");
